...
describe('DesktopSignUp', () => {
  it('renders the create account heading', () => {
    render(<DesktopSignUp onSubmit={vi.fn()} onGoogle={vi.fn()} onSignIn={vi.fn()} />, {
      wrapper: I18nWrapper,
    })
  ...
  it('calls onSubmit with name and email when Create account is clicked', () => {
    ...
    render(<DesktopSignUp onSubmit={onSubmit} onGoogle={vi.fn()} onSignIn={vi.fn()} />, {
      wrapper: I18nWrapper,
    })
  ...
  it('calls onGoogle when the Google button is clicked', () => {
    ...
    render(<DesktopSignUp onSubmit={vi.fn()} onGoogle={onGoogle} onSignIn={vi.fn()} />, {
      wrapper: I18nWrapper,
    })
  ...
  it('calls onSignIn when the sign-in link is clicked', () => {
    ...
    render(<DesktopSignUp onSubmit={vi.fn()} onGoogle={vi.fn()} onSignIn={onSignIn} />, {
      wrapper: I18nWrapper,
    })
