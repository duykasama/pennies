...
import DesktopTwoFactor from '../TwoFactor'

describe('DesktopTwoFactor', () => {
  ...
  it('calls onVerify when Verify and sign in button is clicked', () => {
  ...
  it('calls onBack when the back link is clicked', () => {
    ...
    fireEvent.click(screen.getByText('← Use a different sign-in method'))
